    ...
    try:
        ...
        async with ICUClient(config) as client:
            ...
            for event in events:
                ...
                # created. Normalize to the date string so events from both
                # eras on the same day group together.
                date_obj = datetime.fromisoformat(event.start_date_local).date()
